...
public class HttpClientPost {
	...
	public void register() throws Exception {
		...
		//url = "http://localhost:8050/jt/sso/user/register";
		Map<String, String> paraMap = new HashMap<String,String>();
		
		paraMap.put("username", "tony221");
		paraMap.put("password", "1234561");
		paraMap.put("phone", "12311");
		paraMap.put("email", "chenzs12131@tedu.cn");
...
//		url = "http://localhost:8050/jt/sso/user/login";
		Map<String, String> paraMap = new HashMap<String,String>();
